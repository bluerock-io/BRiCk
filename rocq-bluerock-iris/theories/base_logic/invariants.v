...
(** NOTE FOR MAINTAINTERS: This is the central authority for controlling the
  ...
  (The instances for [own] are picked by `bedrock.iris.extra.base_logic.own_instances`.)
...
Require Export bedrock.iris.extra.bi.na_invariants.
Require Export bedrock.iris.extra.bi.cancelable_invariants.

(* [own] instances for iProp or monPred *)
Require Export bedrock.iris.extra.base_logic.own_instances.

(* [inv] and [cinv] instances for iProp. Currently not exported. *)
(* Require Export bedrock.iris.extra.base_logic.iprop_invariants. *)
...
Require Export bedrock.iris.extra.bi.weakly_objective.
Require Export bedrock.iris.extra.base_logic.monpred_invariants.
